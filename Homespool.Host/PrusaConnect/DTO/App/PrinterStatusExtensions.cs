...
/// rather than a shared enum: the two vocabularies happen to carry
...
public static class PrinterStatusExtensions
{
    ...
    /// <c>OFFLINE</c> are server-synthesised connectivity/aggregate states that Buddy never puts
    /// on the wire, so accepting them here would let a
