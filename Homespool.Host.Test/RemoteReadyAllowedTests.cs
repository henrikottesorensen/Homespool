...
public sealed class RemoteReadyAllowedTests : IDisposable
{
    ...
    {
        return new PrinterQueryService(context, TestTelemetryContext.For(context), new PrinterAccessService(context, NullLogger<PrinterAccessService>.Instance), new TeamCapabilityLookup(context), TimeProvider.System);
    }
