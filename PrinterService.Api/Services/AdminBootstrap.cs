...
public static class AdminBootstrap
{
    ...
    /// <summary>
    /// Runs once at startup, after <see cref="Data.DataServiceCollectionExtensions.MigratePrinterServiceData"/>
    ...
    private static async Task SeedAsync(IServiceProvider services)
    {
        ...
        IList<PSUser> admins = await userManager.GetUsersInRoleAsync(AdminRole);
