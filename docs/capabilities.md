...
An administrator can also revoke every token an account holds, and closing an account does it
automatically — so a token outlives its owner's password change, but not their account.
