...
/// <param name="Names">Addresses the certificate covers, best first. Empty means a bundle cannot be built.</param>
                                 ...
                                 bool TlsEnabled)
{
    ...
    public string? PreferredName => Names.Count > 0 ? Names[0] : null;
