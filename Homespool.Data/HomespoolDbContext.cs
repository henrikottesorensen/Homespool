...
public class HomespoolDbContext : IdentityDbContext<HSUser, IdentityRole<long>, long>, IDataProtectionKeyContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        // The five tables the telemetry stream writes. Shared with TelemetryDbContext, which is what
        // actually reads and writes them - this context keeps mapping them because it owns the schema
        // and the migration, whichever database the rows end up living in.
        TelemetryModel.Configure(builder, withPrinterForeignKeys: true);
