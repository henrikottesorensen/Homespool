...
public class ProvisioningReadmeTests
{
    ...
    {
        string readme = ProvisioningReadme.Build(PrinterEndpoint.Default(Options()), "printers.example.com", "Bench printer", TestLocaliser.Shared());
    ...
    {
        string readme = ProvisioningReadme.Build(PrinterEndpoint.Default(Options()), "192.168.13.238", "Bench printer", TestLocaliser.Shared());
    ...
    {
        string readme = ProvisioningReadme.Build(PrinterEndpoint.Default(Options(tls)), "192.168.13.238", "Bench printer", TestLocaliser.Shared());
    ...
    {
        ProvisioningReadme.Build(PrinterEndpoint.Default(Options()), "192.168.13.238", printerName: null, TestLocaliser.Shared())
    ...
    {
        string readme = ProvisioningReadme.Build(PrinterEndpoint.Default(Options(tls: false)), "192.168.13.238", "Bench printer", TestLocaliser.Shared());
