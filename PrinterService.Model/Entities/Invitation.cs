...
/// </summary>
/// <remarks>
/// The token is minted by <c>CodeGenerator</c> (base36) and only its hash is stored, via
/// <c>TokenService</c> (PBKDF2/SHA3-384) — the same scheme that protects the printer registration
/// token at rest. The plaintext is shown or mailed once at creation and never persisted.
/// </remarks>
