...
{
    /// <summary>
    /// Fetches a single frame from the stream server, or returns <see langword="null"/> if it could
    /// not be read.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    Task<CameraFrame?> FetchAsync(Uri uri, CancellationToken cancellationToken);
}
